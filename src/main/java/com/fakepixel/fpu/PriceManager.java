                ...
                try {
                    ...
                    if (conn.getResponseCode() == 200) {
                        ...
                        ItemData data = new ItemData(
                            json.get("bzBuy").getAsString(), json.get("bzSell").getAsString(), 
                            json.get("ahHigh").getAsString(), json.get("ahLow").getAsString(), 
                            json.get("ahAvg").getAsString(), json.get("lastUpdated").getAsString()
                        );
